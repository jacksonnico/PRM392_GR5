...
public class AdminMessagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages = dbHelper.getMessages("user"); // Giả định Admin nhận tin nhắn từ User
        ...
        btnSend.setOnClickListener(v -> {
            ...
            if (!messageText.isEmpty()) {
                ...
                Message newMessage = new Message(0, "Admin", messageText, currentTime, "user"); // Gửi đến User
